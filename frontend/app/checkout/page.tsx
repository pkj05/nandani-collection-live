...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.1.7:8000/api/orders/create", {
        method: "POST",
        headers: {
  ...
  if (cart.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <Link href="/" className="bg-primary text-white px-8 py-3 rounded-full font-bold shadow-lg hover:scale-105 transition-transform">Shopping Shuru Karein</Link>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
              ...
              {error && (
                <div className="mb-6 p-4 bg-red-50 text-red-600 rounded-lg flex items-center gap-2 text-sm border border-red-100 animate-pulse">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    maxLength={10}
                    className="w-full p-3 pl-14 border rounded-lg outline-primary bg-gray-50/50"
                    value={form.phone}
                ...
                <input 
                  ...
                  className="w-full p-3 border rounded-lg outline-primary bg-gray-50/50 md:col-span-2"
                  value={form.address}
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
              ...
              <div className="space-y-3 text-sm border-t pt-4">
                ...
                <div className="flex justify-between text-xl font-bold border-t pt-3 mt-3 text-gray-900">
